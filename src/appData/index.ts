...
export const serviceData = [
  {
    ...
    shortDescription:
      'Building dynamic, interactive, and performance-optimized web applications using modern JavaScript.',
  },
  {
    icon: ReactIcon,
    title: 'React.js Development',
    shortDescription:
      'Creating modern, scalable, and responsive user interfaces using React.js.',
  },
  {
    icon: NodejsIcon,
    title: 'Node.js Backend Development',
    shortDescription:
      'Developing secure, scalable, and high-performance server-side applications and APIs with Node.js.',
  },
  {
    icon: NextjsIcon,
    title: 'Next.js Development',
    shortDescription:
      'Building production-ready, SEO-friendly, and server-rendered applications with Next.js.',
  },
  {
    icon: TypescriptIcon,
    title: 'TypeScript Development',
    shortDescription:
      'Writing strongly-typed, maintainable, and scalable applications using TypeScript.',
  },
  {
    icon: TailwindCSS,
    title: 'UI Development with Tailwind CSS',
    shortDescription:
      'Designing clean, responsive, and modern user interfaces using Tailwind CSS.',
  },
  {
    icon: Rust,
    title: 'Rust & Web3 Development',
    shortDescription:
      'Building high-performance backend systems and blockchain-based applications using Rust.',
  },
  {
    icon: Laravel,
    title: 'Laravel Backend Development',
    shortDescription:
      'Developing structured and scalable web applications using Laravel and PHP.',
  },
];
